...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # pre-process
        sample = self.conv_in(sample) #[2, 4, 15, 64, 64]->[2, 320, 15, 64, 64] b c f h w
        ...
        sample = self.mid_block(
            ...
            inter_frame=inter_frame, t_real=timestep, inverse=inverse, h_state=h_state, attention_t=attention_t, inds=inds,####################################
            **kwargs, 
        )
